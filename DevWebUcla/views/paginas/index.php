...
<section class="speakers">
    ...
    <p class="speakers__descripcion">Conoce a nuestros expertos de DevWebUcla</p>
...
<section class="boletos">
    ...
    <p class="boletos__descripcion">Precios para DevWebUcla</p>

    <div class="boletos__grid">
        <div <?php aos_animacion(); ?> class="boleto boleto--presencial">
            <h4 class="boleto__logo">&#60;DevWebUcla /></h4>
