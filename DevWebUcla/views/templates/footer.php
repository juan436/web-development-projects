    ...
    <div class="footer__grid" >
        <div class="footer_contenido">
            ...
            <p class="footer__texto" >
                DevWebUcla es una conferencia par desarrolladores de todos 
                los niveles, se lleva a cabo de forma presencial y en lineal.
            </p>
        </div>
        ...
        <nav class="menu-redes"> 
            ...
            <a class="menu-redes__enlace" rel="noopener noreferrer" target="_blank" href="https://instagram.com/">
                <span class="menu-redes__ocultar">Instagrasm</span>
            </a> 
